...
MAX_VAE_SAMPLES = 10
NUM_LP = 200
NUM_AL = 1000  # your chosen budget
BATCH_SIZE = 128
VAE_EPOCHS = 2
VAE_BATCH = 32
...
print("[1] Loading SENSOR_CSV and selecting numeric sensor columns...")
df_all = pd.read_csv(SENSOR_CSV)
# only numeric columns (skip dates/strings)
...
# ─── 5) Dynamic‐reward Q‐learning with Active Learning ─────────────────────────
